...
ActiveRecord::Schema.define(version: 20160225162150) do
  ...
  add_index "lessons", ["name", "skill_id"], name: "index_lessons_on_name_and_skill_id", unique: true, using: :btree
  ...
  add_index "translations", ["word_1_id", "word_2_id"], name: "index_translations_on_word_1_id_and_word_2_id", unique: true, using: :btree
