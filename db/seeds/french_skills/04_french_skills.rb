...
french_basic_1 = Skill.find_or_create_by(
  name: "Basics 1",
...
french_basic_2 = Skill.find_or_create_by(
  name: "Basics 2",
  course_id: french_for_english.id,
  tips_and_notes: ""
 )
french_basic_3 = Skill.find_or_create_by(
  name: "Basics 3",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
french_greetings = Skill.find_or_create_by(
  name: "Greetings",
  course_id: french_for_english.id,
  tips_and_notes: "Get ready to be able to greet people in French!"
)
french_adjectives = Skill.find_or_create_by(
  name: "Adjectives",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
french_pronouns = Skill.find_or_create_by(
  name: "Pronouns",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
french_verbs_1 = Skill.find_or_create_by(
  name: "Basic Verbs 1",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
french_verbs_2 = Skill.find_or_create_by(
  name: "Basic Verbs 2",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
french_verbs_3 = Skill.find_or_create_by(
  name: "Basic Verbs 3",
  course_id: french_for_english.id,
  tips_and_notes: ""
)
