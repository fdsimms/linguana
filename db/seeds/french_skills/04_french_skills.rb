...
french_adjectives = Skill.create!(
  name: "Adjectives",
  course_id: french_for_english.id,
  tips_and_notes: "Let's start off with the two most important things about French adjectives. Like French articles, French adjectives have to agree with the number and gender of the noun that they modify. And unlike English adjectives, French adjectives generally come after the noun rather than before. So 'the red dog' translates to 'el perro rojo'. Some adjectives, like 'increíble' ('incredible'), don't change according to gender. 'Las madres increíbles' and 'los padres increíbles' are both correct. There isn't much more to say than that: let's go!"
)
french_pronouns = Skill.create!(
  name: "Pronouns",
  course_id: french_for_english.id,
  tips_and_notes: "The most important thing to consider when dealing with French pronouns is which version of 'you' to use. 'Tú' is used in familiar conversation, when you're talking with a friend or a family member or someone of a similar age in an informal context. 'Usted' is more formal–it was originally a contraction of the French for 'Your Mercy'–and is used with people to whom you should show respect, especially elders. The rules for using these two pronouns differs from country to country; in some countries, 'tú' is seen as childish no matter whom you use it with, and in others, 'usted' is almost never heard. Note also that 'nosotros' is used for 'we' even if the group you're talking about includes 10,000 men and a single woman. A little unfair, huh?"
)
